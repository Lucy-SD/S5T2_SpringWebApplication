...
public class ActivityMapper {
    ...
    public ActivityJpaEntity toEntity(Activity activity) {
        ActivityJpaEntity entity = ActivityJpaEntity.builder()
                ...
                .customFrequencyValue(activity.getCustomFrequencyValue())
                .customFrequencyUnit(activity.getCustomFrequencyUnit())
    ...
    public Activity toDomain(ActivityJpaEntity entity) {
        return Activity.builder()
                ...
                .customFrequencyValue(entity.getCustomFrequencyValue())
                .customFrequencyUnit(entity.getCustomFrequencyUnit())
